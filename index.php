...
$(document).ready(function() {
	...
	function map_initialize()
	{
		...
		google.maps.event.addListener(map, 'rightclick', function(event) {
			...
			var EditForm = '<p><div class="marker-edit">'+
					...
					'<label for="pType"><span>Tipo de consultorio :</span> <select name="pType" class="save-type"><option value="clinica privada">Clinica Privada</option><option value="clinica publica">Clinica Publica</option><option value="Institucion publica">Institucion Publica</option>'+
	...
	function create_marker(MapPos, MapTitle, MapDesc,  InfoOpenDefault, DragAble, Removable, iconPath)
	{
		...
		var contentString = $('<div class="marker-info-win">'+
				...
				MapDesc+
				'</span><button name="remove-marker" class="remove-marker" title="Remove Marker">Eliminar ubicacion</button>'+
				'</div></div>');
